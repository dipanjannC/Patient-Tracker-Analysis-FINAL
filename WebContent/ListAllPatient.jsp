							...
							<!-- Search Bar -->	
								...
								<div class="col-4">
									<div align="right">
										...
										<a href="patientAddition" role="button""> <i class="material-icons"
						...
						<div class="table-responsive" style="background: #f0e8f7">
							<table id="mytable" class="table table-bordred table-striped">
								...
								<tbody>
									...
									<tr>
										 <td><a href="viewPatientDetails?id=<%=pojo.getPatientId() %>" class="btn btn-basic" role="button"><%=pojo.getPatientId() %></a></td> 
										<td><%=pojo.getFirstName() %></td>
										<td><%=pojo.getLastName() %></td>
										<td><%=pojo.getState() %></td>
										<td><%=pojo.getEmailId() %></td>
										<td><%=pojo.getContactNumber() %></td>
										 <td><a href="patientUpdation?id=<%=pojo.getPatientId() %>" role="button"><i class="material-icons">mode_edit</i></a></td>
