...
<title>ID Medicine Details</title>
<!-- Bootstrap CSS -->
<link rel="stylesheet"
					...
					<div class="card-deck ">
						...
						<div class="card" style="width: 18rem;">
							...
							<div class="card-body text-center">
								...
								<a href="medicineUpdation?id=<%=pojo.getMedicineId() %>" class="btn btn-primary">Edit Details</a>
							</div>
						...
						<div class="card " style="background:#e0e0eb">
							<div class="card-header" style="background: #eaeafb;"><%=pojo.getMedicineId() %></div>
							<div class="card-body text-center">
								<p class="card-text text-left">Medicine Description: <%=pojo.getMedicineDescription() %></p>
								<p class="card-text text-left">Cure For: <%=pojo.getCureFor() %></p>
								<p class="card-text text-left">Manufacturing Company: <%=pojo.getManufacturingCompany() %></p>
								<p class="card-text text-left">Dosage: <%=pojo.getDosage() %></p>
								<p class="card-text text-left">Prescribed For: <%=pojo.getPrescribedFor() %></p>
								<p class="card-text text-left">Amount: <%=pojo.getAmount() %></p>
							</div>
						</div>
