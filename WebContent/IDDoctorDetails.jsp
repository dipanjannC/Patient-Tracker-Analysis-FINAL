					...
					<div class="card-deck ">
						...
						<div class="card" style="width: 18rem;">
							...
							<div class="card-body text-center">
								...
								<a href="doctorUpdation?id=<%=pojo.getDoctorId() %>" class="btn btn-primary">Edit Profile</a>
							</div>
						...
						<div class="card " style="background:#e0e0eb">
							...
							<div class="card-body text-center">
								...
								<p class="card-text text-left">Zipcode: <%=pojo.getZipCode() %></p>
								<p class="card-text text-left">Degree: <%=pojo.getDegree() %></p>
								<p class="card-text text-left">Specialty: <%=pojo.getSpeciality() %></p>
								<p class="card-text text-left">Work Hours: <%=pojo.getWorkHours() %></p>
								<p class="card-text text-left">Hospital/Clinic Name: <%=pojo.getHospitalName() %></p>
							</div>
						</div>
