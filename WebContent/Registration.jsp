					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<form:input path="firstName" type="text" placeholder="Enter Admin's First Name" class="form-control" name="first-name" maxlength="20" required="required" />
							</div>
							<div class="col-sm-6 form-group">
								<label>Last Name</label> 
								<form:input path="lastName" type="text" placeholder="Enter Admin's Last Name" class="form-control" name="last-name" maxlength="20" required="required" />
							</div>
						</div>
