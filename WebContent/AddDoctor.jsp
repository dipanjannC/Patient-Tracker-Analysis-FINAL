        ...
        <div class="p-1 flex-grow-1">
            ...
            <div class="container">
				...
				<form:form action="addDoctor" modelAttribute="doctor" method="post" style="width: 100%;">
					...
					<hr>
					<form:input path="age" type="number" placeholder="Enter Doctor's Age" min="1" max="130" name="age"
						required="required" />
					<hr>
					 <form:select path="gender"
						id="gender" name="gender" class="form-control" style="background:lavender" required="required">
						<form:option value="Male">Male</form:option>
						<form:option value="Female">Female</form:option>
					</form:select>
					<hr>
					<form:input path="dateOfBirth" type="date" name="dob" placeholder="Enter Date of Birth"  max="<%= fDate %>" required="required"/>
					<hr>
					<label for="addressl1"></label> <form:input path="addressLine1" type="textarea" 
					...
					<label for="addressl2"></label> <form:input path="addressLine2" type="textarea" 
						name="addressl2" id="" placeholder="Enter Address Line 2" required="required" />
					<hr>
					...
					<hr>
					<label for="speciality"></label> <form:input path="speciality" type="text" name="speciality"
						id="speciality" placeholder="Enter Doctor's Speciality" required="required" />
					<hr>
					<label for="workhours"></label> <form:input path="workHours" type="number" name="workhours" pattern="[0-24]{0,24}" maxlength="2"
						id="workhours" placeholder="Enter Doctor's Work Hours" required="required" />
					<hr>
					<label for="hospitalname"></label> <form:input path="hospitalName" type="text" name="hospitalname"
						id="hospitalname" placeholder="Enter Doctor's Hospital Name" required="required" />
					<hr>
					<label for="city"></label> <form:input path="city" type="text" name="city"
						id="city" placeholder="Enter Doctor's City" required="required" />
					<hr>
					<label for="state"></label> <form:input path="state" type="text"
						 name="state" id="state" placeholder="Enter Doctor's State" required="required" />
					<hr>
					<label for="zipcode"></label> <form:input path="zipCode" type="text"
						name="zipcode" id="zipcode" placeholder="Enter Doctor's Zip Code" required="required"  pattern="[0-9]{6,}" title="Don't begin with '0'" maxlength="6"/>
					<hr>
					<label for="contact"></label> <form:input path="contactNumber" type="text" pattern="[0-9]{10,}" title="Don't include '0'" maxlength="10"
						name="contactnumber" id="contact" placeholder="Enter Doctor's Contact Number" required="required" />
					<hr>
					<label for="altcontact"></label> <form:input path="alternateContactNumber" pattern="[0-9]{10,}" title="Don't include '0'" maxlength="10"
					...
					<label for="email"></label> <form:input path="emailId" type="email" name="email"
						id="email" placeholder="Enter Doctor's Personal Email ID" required="required" />
					<hr>


                                <div align="right">
                                    <input type="submit" class="btn btn-project" value="ADD" name="adddoctor"> <input type="reset"
