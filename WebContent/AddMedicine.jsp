        ...
        <div class="p-1 bg mr-2" style="border-radius: 5px;">
            ...
            <nav id="sidebar" style="box-shadow:0px 20px 50px grey; border-radius: 25px;">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li><a href="listAllPatient">Medicine</a></li>
                ...
                <div class="card" style="box-shadow:0px 20px 50px grey;">
                    ...
                    <div class="card-body">
                        <div style="background:#f0e8f7">
                            ...
                            <form:form action="addMedicine" modelAttribute="medicine" method="post" style="width: 100%;">
                                <form:input path="medicineDescription" type="textarea" name="description" placeholder="Medicine Description" required="required" />
                                <hr>
                                <form:input path="cureFor" type="textarea" name="curefor" placeholder="Cure For" required="required" />
                                <hr>
                                <form:input path="manufacturingCompany" type="text" placeholder="Manufacturing Company"  name="company" required="required"/>
                                <hr>
                                <form:input path="dosage" type="number" name="dosage" placeholder="Enter Dosage Required" required="required" />
                                <hr>
                                <form:input path="prescribedFor" type="textarea" name="prescribedfor" placeholder="Medicine Prescribed For"
                                    required="required" />
                                <hr>
