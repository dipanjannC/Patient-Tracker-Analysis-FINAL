				...
				<div class="card" style="box-shadow: 0px 20px 50px grey;">
					...
					<div class="card-body">
						<div style="background: #f0e8f7">
							...
							<form:form action="addMedicine" modelAttribute="medicine"
								method="post" style="width: 100%;">

								<form:input path="medicineDescription" type="textarea"
									maxlength="30" name="description" placeholder="Description"
									required="required" />
								<hr>
								<form:input path="cureFor" type="textarea" name="curefor"
									maxlength="30" placeholder="Cure For" required="required" />
								<hr>
								<form:input path="manufacturingCompany" type="text"
									maxlength="20" placeholder="Manufacturing Company"
									name="company" required="required" />
								<hr>
								<form:input path="dosage" type="number" name="dosage"
									maxlength="5" placeholder="Dosage Required (in mg)"
									required="required" />
								<hr>
								<form:input path="prescribedFor" type="textarea" maxlength="30"
									name="prescribedfor" placeholder="Prescribed For"
									required="required" />
								<hr>
								<form:input path="amount" type="number" name="amount"
									maxlength="5" placeholder="Amount (in Rs.)" required="required" />
								<hr>
								<div align="right">
