				...
				<div class="card" style="box-shadow: 0px 20px 50px grey;">
					...
					<div class="card-body">
						<div style="background: #f0e8f7">
							...
							<form:form action="addClerk" method="post" modelAttribute="clerk"
								style="width: 100%;">

								<form:input path="firstName" type="text" name="fname"
									placeholder="First Name" maxlength="20" required="required" />
								<hr>
								<form:input path="lastName" type="text" name="lname"
									placeholder="Last Name" maxlength="20" required="required" />
								<hr>
								<form:input path="age" type="number" placeholder="Age" min="1"
									max="130" name="age" maxlength="3" required="required" />
								<hr>
								...
								<form:input path="addressLine1" type="textarea"
									name="addressLine1" id="addressLine1" maxlength="20"
								...
								<form:input path="state" type="text" class="form-control"
									maxlength="15" name="state" id="state" placeholder="State"
									required="required" />
								<hr>
								...
								<form:input path="contactNumber" type="text"
									name="contactNumber" id="contactNumber" pattern="[0-9]{10,}"
