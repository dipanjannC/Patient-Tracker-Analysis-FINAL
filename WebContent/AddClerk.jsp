                ...
                <div class="card" style="box-shadow:0px 20px 50px grey;">
                    ...
                    <div class="card-body">
                        <div style="background:#f0e8f7">
                            ...
                            <form:form action="addClerk" method="post" modelAttribute="clerk" style="width: 100%;">
                                <form:input path="firstName" type="text" name="fname" placeholder="Enter Clerk's First Name" maxlength="20" required="required" />
                                <hr>
                                <form:input path="lastName" type="text" name="lname" placeholder="Enter Clerk's Last Name" maxlength="20" required="required" />
                                <hr>
                                <form:input path="age" type="number" placeholder="Age" min="1" max="130" name="age" maxlength="3" required="required"/>
                                <hr>
                                <form:select path="gender" id="gender" name="gender" placeholder="Gender" class="form-control" style="background:lavender"
                                    required="required">
                                ...
                                <hr>
                                <label for="addressl1"></label> <form:input path="addressLine1" type="textarea" name="addressLine1" id="addressLine1"
                                    placeholder="Address Line 1" required="required" />
                                <hr>
                                <label for="addressl2"></label> <form:input path="addressLine2" type="textarea" name="addressLine1" id="addressLine1" placeholder="Address Line 2"
                                    required="required" />
                                <hr>
                                <label for="city"></label> <form:input path="city" type="text" name="city" id="city" placeholder="City"
                                    required="required" />
                                <hr>
                                <label for="state"></label> <form:input path="state" type="text" class="form-control" name="state" id="state"
                                    placeholder="State" required="required" />
                                <hr>
                                <label for="zipcode"></label> <form:input path="zipCode" type="text" name="zipcode" id="zipcode"
                                    placeholder="Zip Code" required="required" pattern="[0-9]{6,}" title="Don't begin with '0'" maxlength="6"/>
                                <hr>
                                <label for="contact"></label> <form:input path="contactNumber" type="text" name="contactNumber" id="contactNumber" pattern="[0-9]{10,}" 
	                                title="Don't begin with '0'" maxlength="10"
                                ...
                                <label for="altcontact"></label> <form:input path="alternateContactNumber" type="text" name="alternateContactNumber" id="alternateContactNumber"
                                 pattern="[0-9]{10,}" title="Don't include '0'"
