				...
				<div class="card" style="box-shadow: 0px 20px 50px grey;">
					...
					<div class="card-body">
						<div style="background: #f0e8f7">
							...
							<form:form action="updateClerk" method="post"
								modelAttribute="clerk" style="width: 100%;">

								<%
									ClerkPOJO pojo = (ClerkPOJO) request.getAttribute("pojo");
								%>

								<form:input path="clerkId" type="text" name="clerkId"
									value="<%=pojo.getClerkId()%>" readonly="true" />
								<hr>
								<form:input path="firstName" type="text" name="fname"
									value="<%=pojo.getFirstName()%>" placeholder="First Name"
									maxlength="20" required="required" />
								<hr>
								<form:input path="lastName" type="text" name="lname"
									value="<%=pojo.getLastName()%>" placeholder="Last Name"
									maxlength="20" required="required" />
								<hr>
								...
								<form:select path="gender" id="gender" name="gender"
									...
									style="background:lavender" placeholder="Gender"
									required="required">
								...
								<form:input path="dateOfBirth" type="date" name="dob"
									value="<%=pojo.getDateOfBirth()%>" required="required"
									placeholder="Date of Birth (dd-mm-yyyy)" />
								<hr>
								<label for="addressl1"></label>
								<form:input path="addressLine1" type="textarea" maxlength="20"
									name="addressLine1" placeholder="Address Line 1"
									id="addressLine1" value="<%=pojo.getAddressLine1()%>"
									required="required" />
								<hr>
								<label for="addressl2"></label>
								<form:input path="addressLine2" type="textarea" maxlength="20"
								...
								<form:input path="contactNumber" type="text"
									...
									maxlength="10" value="<%=pojo.getContactNumber()%>"
									required="required" />
								<hr>
								...
								<form:input path="emailId" type="email" placeholder="Email"
									maxlength="25" name="email" id="email"
