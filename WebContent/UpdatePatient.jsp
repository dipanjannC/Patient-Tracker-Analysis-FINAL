					...
					<div class="card-body">
						<div style="background: #f0e8f7">
							...
							<form:form action="updatePatient" method="post"
								modelAttribute="patient" style="width: 100%;">
								...
								<form:input path="patientId" type="text" name="patientId"
									value="<%=pojo.getPatientId()%>" readonly="true" />
								<hr>
								...
								<form:input path="emailId" type="email" name="email" id="email"
									placeholder="Email ID" maxlength="15"
